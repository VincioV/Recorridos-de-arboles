...
public void RecorrOrden(DefaultMutableTreeNode nodoRaiz)
    {
        if(!nodoRaiz.getUserObject().toString().equals("I - NULL") && !nodoRaiz.getUserObject().toString().equals("D - NULL"))
        ...
        {
            strRecorrido += nodoRaiz.getUserObject().toString().split("-")[1].trim() + " - ";
            RecorrOrden((DefaultMutableTreeNode) nodoRaiz.getLastChild());
            RecorrOrden(nodoRaiz);
            RecorrOrden((DefaultMutableTreeNode) nodoRaiz.getFirstChild());
        }
    }
